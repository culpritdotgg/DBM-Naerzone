...
DBM = {
	Revision = parseCurseDate("20241009120000"),
	DisplayVersion = "9.3", -- the string that is shown as version
	ReleaseRevision = releaseDate(2024, 10, 09) -- the date of the latest stable version that is available, optionally pass hours, minutes, and seconds for multiple releases in one day
}
